...
import { Mail, Phone, Linkedin, Github, UserCircle, Sparkles, Briefcase, GraduationCap, Lightbulb, ExternalLink } from 'lucide-react';
...
export default function PortfolioHomePage() {
  const { cvData, profession } = usePortfolioContext();

  if (!cvData) return null; // Handled by layout
