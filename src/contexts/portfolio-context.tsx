...
interface PortfolioContextType {
  ...
  setTheme: Dispatch<SetStateAction<PortfolioTheme | null>>; // Function to set the active theme
...
export function PortfolioProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    try {
      ...
      if (storedTheme) {
        // Loads the theme WITHOUT previewImageDataUri, as it was stripped before saving
  ...
  const setTheme: Dispatch<SetStateAction<PortfolioTheme | null>> = (value) => {
    ...
    setThemeState(newValue); // Update React state with the full object
     if (newValue === null) {
      localStorage.removeItem(THEME_RECOMMENDATION_KEY);
    } else {
      // Create a new object for storing in localStorage, omitting previewImageDataUri
